...
namespace Drupal\cucumber\entity;
...
/**
 * Cucumber Entity Definition Update Manager.
 *
 * Customized class from the Devel Entity Updates module
 * Development version of the entity definition update manager.
 */
final class CucumberEntityDefinitionUpdateManager implements ContainerInjectionInterface {
